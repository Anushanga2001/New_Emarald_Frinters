...
function add(dirtyDate, duration) {
	...
	var months$1 = duration.months ? toInteger(duration.months) : 0;
	var weeks = duration.weeks ? toInteger(duration.weeks) : 0;
	var days$1 = duration.days ? toInteger(duration.days) : 0;
	var hours = duration.hours ? toInteger(duration.hours) : 0;
	var minutes = duration.minutes ? toInteger(duration.minutes) : 0;
	var seconds = duration.seconds ? toInteger(duration.seconds) : 0;
	var date = toDate(dirtyDate);
	var dateWithMonths = months$1 || years ? addMonths(date, months$1 + years * 12) : date;
	var dateWithDays = days$1 || weeks ? addDays(dateWithMonths, days$1 + weeks * 7) : dateWithMonths;
...
function startOfWeek(dirtyDate, options) {
	...
	requiredArgs(1, arguments);
	var defaultOptions$1 = getDefaultOptions$1();
	var weekStartsOn = toInteger((_ref = (_ref2 = (_ref3 = (_options$weekStartsOn = options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null && _options$weekStartsOn !== void 0 ? _options$weekStartsOn : options === null || options === void 0 ? void 0 : (_options$locale = options.locale) === null || _options$locale === void 0 ? void 0 : (_options$locale$optio = _options$locale.options) === null || _options$locale$optio === void 0 ? void 0 : _options$locale$optio.weekStartsOn) !== null && _ref3 !== void 0 ? _ref3 : defaultOptions$1.weekStartsOn) !== null && _ref2 !== void 0 ? _ref2 : (_defaultOptions$local = defaultOptions$1.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.weekStartsOn) !== null && _ref !== void 0 ? _ref : 0);
...
function getUTCWeekYear(dirtyDate, options) {
	...
	var year = date.getUTCFullYear();
	var defaultOptions$1 = getDefaultOptions$1();
	var firstWeekContainsDate = toInteger((_ref = (_ref2 = (_ref3 = (_options$firstWeekCon = options === null || options === void 0 ? void 0 : options.firstWeekContainsDate) !== null && _options$firstWeekCon !== void 0 ? _options$firstWeekCon : options === null || options === void 0 ? void 0 : (_options$locale = options.locale) === null || _options$locale === void 0 ? void 0 : (_options$locale$optio = _options$locale.options) === null || _options$locale$optio === void 0 ? void 0 : _options$locale$optio.firstWeekContainsDate) !== null && _ref3 !== void 0 ? _ref3 : defaultOptions$1.firstWeekContainsDate) !== null && _ref2 !== void 0 ? _ref2 : (_defaultOptions$local = defaultOptions$1.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.firstWeekContainsDate) !== null && _ref !== void 0 ? _ref : 1);
...
var formatters$1 = {
	...
	S: function S(date, token) {
		...
		var milliseconds$1 = date.getUTCMilliseconds();
		return addLeadingZeros(Math.floor(milliseconds$1 * Math.pow(10, numberOfDigits - 3)), token.length);
	}
};
var lightFormatters_default = formatters$1;
...
var formatters = {
	G: function G(date, token, localize$1) {
	...
	y: function y(date, token, localize$1) {
		if (token === "yo") {
			var signedYear = date.getUTCFullYear();
			var year = signedYear > 0 ? signedYear : 1 - signedYear;
	...
	Y: function Y(date, token, localize$1, options) {
	...
	Q: function Q(date, token, localize$1) {
	...
	M: function M(date, token, localize$1) {
		var month = date.getUTCMonth();
		switch (token) {
			case "M":
			case "MM": return lightFormatters_default.M(date, token);
	...
	L: function L(date, token, localize$1) {
		var month = date.getUTCMonth();
		switch (token) {
	...
	w: function w(date, token, localize$1, options) {
		var week = getUTCWeek(date, options);
		if (token === "wo") return localize$1.ordinalNumber(week, { unit: "week" });
		return addLeadingZeros(week, token.length);
	},
	I: function I(date, token, localize$1) {
		var isoWeek = getUTCISOWeek(date);
		if (token === "Io") return localize$1.ordinalNumber(isoWeek, { unit: "week" });
		return addLeadingZeros(isoWeek, token.length);
	},
	d: function d(date, token, localize$1) {
		if (token === "do") return localize$1.ordinalNumber(date.getUTCDate(), { unit: "date" });
	...
	E: function E(date, token, localize$1) {
	...
	e: function e(date, token, localize$1, options) {
		var dayOfWeek = date.getUTCDay();
	...
	c: function c(date, token, localize$1, options) {
		var dayOfWeek = date.getUTCDay();
		var localDayOfWeek = (dayOfWeek - options.weekStartsOn + 8) % 7 || 7;
		switch (token) {
	...
	a: function a(date, token, localize$1) {
		var dayPeriodEnumValue = date.getUTCHours() / 12 >= 1 ? "pm" : "am";
		switch (token) {
			case "a":
	...
	b: function b(date, token, localize$1) {
	...
	h: function h(date, token, localize$1) {
		if (token === "ho") {
	...
	H: function H(date, token, localize$1) {
		if (token === "Ho") return localize$1.ordinalNumber(date.getUTCHours(), { unit: "hour" });
		return lightFormatters_default.H(date, token);
	},
	K: function K(date, token, localize$1) {
		var hours = date.getUTCHours() % 12;
	...
	m: function m(date, token, localize$1) {
		if (token === "mo") return localize$1.ordinalNumber(date.getUTCMinutes(), { unit: "minute" });
		return lightFormatters_default.m(date, token);
	},
	s: function s(date, token, localize$1) {
		if (token === "so") return localize$1.ordinalNumber(date.getUTCSeconds(), { unit: "second" });
...
var dateLongFormatter = function dateLongFormatter$1(pattern, formatLong$1) {
	switch (pattern) {
...
var timeLongFormatter = function timeLongFormatter$1(pattern, formatLong$1) {
	switch (pattern) {
...
var longFormatters = {
	p: timeLongFormatter,
	P: function dateTimeLongFormatter(pattern, formatLong$1) {
...
function throwProtectedError(token, format$1, input) {
	if (token === "YYYY") throw new RangeError("Use `yyyy` instead of `YYYY` (in `".concat(format$1, "`) for formatting years to the input `").concat(input, "`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md"));
	else if (token === "YY") throw new RangeError("Use `yy` instead of `YY` (in `".concat(format$1, "`) for formatting years to the input `").concat(input, "`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md"));
	else if (token === "D") throw new RangeError("Use `d` instead of `D` (in `".concat(format$1, "`) for formatting days of the month to the input `").concat(input, "`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md"));
	else if (token === "DD") throw new RangeError("Use `dd` instead of `DD` (in `".concat(format$1, "`) for formatting days of the month to the input `").concat(input, "`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md"));
}
...
var formatDistance$1 = function formatDistance$2(token, count, options) {
	var result;
...
var formatDistance_default = formatDistance$1;
...
var formatRelative$1 = function formatRelative$2(token, _date, _baseDate, _options) {
	return formatRelativeLocale[token];
};
var formatRelative_default = formatRelative$1;
...
function format(dirtyDate, dirtyFormatStr, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	var firstWeekContainsDate = toInteger((_ref2 = (_ref3 = (_ref4 = (_options$firstWeekCon = options === null || options === void 0 ? void 0 : options.firstWeekContainsDate) !== null && _options$firstWeekCon !== void 0 ? _options$firstWeekCon : options === null || options === void 0 ? void 0 : (_options$locale2 = options.locale) === null || _options$locale2 === void 0 ? void 0 : (_options$locale2$opti = _options$locale2.options) === null || _options$locale2$opti === void 0 ? void 0 : _options$locale2$opti.firstWeekContainsDate) !== null && _ref4 !== void 0 ? _ref4 : defaultOptions$1.firstWeekContainsDate) !== null && _ref3 !== void 0 ? _ref3 : (_defaultOptions$local = defaultOptions$1.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.firstWeekContainsDate) !== null && _ref2 !== void 0 ? _ref2 : 1);
	if (!(firstWeekContainsDate >= 1 && firstWeekContainsDate <= 7)) throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
	var weekStartsOn = toInteger((_ref5 = (_ref6 = (_ref7 = (_options$weekStartsOn = options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null && _options$weekStartsOn !== void 0 ? _options$weekStartsOn : options === null || options === void 0 ? void 0 : (_options$locale3 = options.locale) === null || _options$locale3 === void 0 ? void 0 : (_options$locale3$opti = _options$locale3.options) === null || _options$locale3$opti === void 0 ? void 0 : _options$locale3$opti.weekStartsOn) !== null && _ref7 !== void 0 ? _ref7 : defaultOptions$1.weekStartsOn) !== null && _ref6 !== void 0 ? _ref6 : (_defaultOptions$local3 = defaultOptions$1.locale) === null || _defaultOptions$local3 === void 0 ? void 0 : (_defaultOptions$local4 = _defaultOptions$local3.options) === null || _defaultOptions$local4 === void 0 ? void 0 : _defaultOptions$local4.weekStartsOn) !== null && _ref5 !== void 0 ? _ref5 : 0);
	if (!(weekStartsOn >= 0 && weekStartsOn <= 6)) throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
...
function formatDistance(dirtyDate, dirtyBaseDate, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	if (!locale$1.formatDistance) throw new RangeError("locale must contain formatDistance property");
	...
	var months$1;
	if (minutes < 2) if (options !== null && options !== void 0 && options.includeSeconds) if (seconds < 5) return locale$1.formatDistance("lessThanXSeconds", 5, localizeOptions);
	else if (seconds < 10) return locale$1.formatDistance("lessThanXSeconds", 10, localizeOptions);
	else if (seconds < 20) return locale$1.formatDistance("lessThanXSeconds", 20, localizeOptions);
	else if (seconds < 40) return locale$1.formatDistance("halfAMinute", 0, localizeOptions);
	else if (seconds < 60) return locale$1.formatDistance("lessThanXMinutes", 1, localizeOptions);
	else return locale$1.formatDistance("xMinutes", 1, localizeOptions);
	else if (minutes === 0) return locale$1.formatDistance("lessThanXMinutes", 1, localizeOptions);
	else return locale$1.formatDistance("xMinutes", minutes, localizeOptions);
	else if (minutes < 45) return locale$1.formatDistance("xMinutes", minutes, localizeOptions);
	else if (minutes < 90) return locale$1.formatDistance("aboutXHours", 1, localizeOptions);
	else if (minutes < MINUTES_IN_DAY$1) {
		var hours = Math.round(minutes / 60);
		return locale$1.formatDistance("aboutXHours", hours, localizeOptions);
	} else if (minutes < MINUTES_IN_ALMOST_TWO_DAYS) return locale$1.formatDistance("xDays", 1, localizeOptions);
	else if (minutes < MINUTES_IN_MONTH$1) {
		var days$1 = Math.round(minutes / MINUTES_IN_DAY$1);
		return locale$1.formatDistance("xDays", days$1, localizeOptions);
	} else if (minutes < MINUTES_IN_TWO_MONTHS) {
		months$1 = Math.round(minutes / MINUTES_IN_MONTH$1);
		return locale$1.formatDistance("aboutXMonths", months$1, localizeOptions);
	}
	...
	if (months$1 < 12) {
		...
		var monthsSinceStartOfYear = months$1 % 12;
		var years = Math.floor(months$1 / 12);
		if (monthsSinceStartOfYear < 3) return locale$1.formatDistance("aboutXYears", years, localizeOptions);
		else if (monthsSinceStartOfYear < 9) return locale$1.formatDistance("overXYears", years, localizeOptions);
		else return locale$1.formatDistance("almostXYears", years + 1, localizeOptions);
	}
}
...
function formatDistanceStrict(dirtyDate, dirtyBaseDate, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	if (!locale$1.formatDistance) throw new RangeError("locale must contain localize.formatDistance property");
	var comparison = compareAsc(dirtyDate, dirtyBaseDate);
	if (isNaN(comparison)) throw new RangeError("Invalid time value");
	var localizeOptions = assign(cloneObject(options), {
		addSuffix: Boolean(options === null || options === void 0 ? void 0 : options.addSuffix),
	...
	var milliseconds$1 = dateRight.getTime() - dateLeft.getTime();
	var minutes = milliseconds$1 / MILLISECONDS_IN_MINUTE;
	var dstNormalizedMinutes = (milliseconds$1 - (getTimezoneOffsetInMilliseconds(dateRight) - getTimezoneOffsetInMilliseconds(dateLeft))) / MILLISECONDS_IN_MINUTE;
	...
	if (unit === "second") {
		var seconds = roundingMethodFn(milliseconds$1 / 1e3);
		...
		var days$1 = roundingMethodFn(dstNormalizedMinutes / MINUTES_IN_DAY);
		return locale$1.formatDistance("xDays", days$1, localizeOptions);
	} else if (unit === "month") {
		var months$1 = roundingMethodFn(dstNormalizedMinutes / MINUTES_IN_MONTH);
		return months$1 === 12 && defaultUnit !== "month" ? locale$1.formatDistance("xYears", 1, localizeOptions) : locale$1.formatDistance("xMonths", months$1, localizeOptions);
	} else if (unit === "year") {
...
function formatDuration(duration, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	var format$1 = (_options$format = options === null || options === void 0 ? void 0 : options.format) !== null && _options$format !== void 0 ? _options$format : defaultFormat;
	var zero = (_options$zero = options === null || options === void 0 ? void 0 : options.zero) !== null && _options$zero !== void 0 ? _options$zero : false;
	var delimiter = (_options$delimiter = options === null || options === void 0 ? void 0 : options.delimiter) !== null && _options$delimiter !== void 0 ? _options$delimiter : " ";
	if (!locale$1.formatDistance) return "";
	return format$1.reduce(function(acc, unit) {
		var token = "x".concat(unit.replace(/(^.)/, function(m) {
			return m.toUpperCase();
		}));
		var value = duration[unit];
		if (typeof value === "number" && (zero || duration[unit])) return acc.concat(locale$1.formatDistance(token, value));
		return acc;
	}, []).join(delimiter);
}
...
function formatISO(date, options) {
	...
	var format$1 = String((_options$format = options === null || options === void 0 ? void 0 : options.format) !== null && _options$format !== void 0 ? _options$format : "extended");
	var representation = String((_options$representati = options === null || options === void 0 ? void 0 : options.representation) !== null && _options$representati !== void 0 ? _options$representati : "complete");
	if (format$1 !== "extended" && format$1 !== "basic") throw new RangeError("format must be 'extended' or 'basic'");
	...
	var result = "";
	var tzOffset = "";
	var dateDelimiter = format$1 === "extended" ? "-" : "";
	var timeDelimiter = format$1 === "extended" ? ":" : "";
...
function formatISODuration(duration) {
	...
	var _duration$years = duration.years, years = _duration$years === void 0 ? 0 : _duration$years, _duration$months = duration.months, months$1 = _duration$months === void 0 ? 0 : _duration$months, _duration$days = duration.days, days$1 = _duration$days === void 0 ? 0 : _duration$days, _duration$hours = duration.hours, hours = _duration$hours === void 0 ? 0 : _duration$hours, _duration$minutes = duration.minutes, minutes = _duration$minutes === void 0 ? 0 : _duration$minutes, _duration$seconds = duration.seconds, seconds = _duration$seconds === void 0 ? 0 : _duration$seconds;
	return "P".concat(years, "Y").concat(months$1, "M").concat(days$1, "DT").concat(hours, "H").concat(minutes, "M").concat(seconds, "S");
}
...
function formatRFC3339(dirtyDate, options) {
	...
	if (fractionDigits > 0) {
		var milliseconds$1 = originalDate.getMilliseconds();
		fractionalSecond = "." + addLeadingZeros(Math.floor(milliseconds$1 * Math.pow(10, fractionDigits - 3)), fractionDigits);
	}
	var offset = "";
...
function formatRelative(dirtyDate, dirtyBaseDate, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	var weekStartsOn = toInteger((_ref2 = (_ref3 = (_ref4 = (_options$weekStartsOn = options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null && _options$weekStartsOn !== void 0 ? _options$weekStartsOn : options === null || options === void 0 ? void 0 : (_options$locale2 = options.locale) === null || _options$locale2 === void 0 ? void 0 : (_options$locale2$opti = _options$locale2.options) === null || _options$locale2$opti === void 0 ? void 0 : _options$locale2$opti.weekStartsOn) !== null && _ref4 !== void 0 ? _ref4 : defaultOptions$1.weekStartsOn) !== null && _ref3 !== void 0 ? _ref3 : (_defaultOptions$local = defaultOptions$1.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.weekStartsOn) !== null && _ref2 !== void 0 ? _ref2 : 0);
	if (!locale$1.localize) throw new RangeError("locale must contain localize property");
	if (!locale$1.formatLong) throw new RangeError("locale must contain formatLong property");
	if (!locale$1.formatRelative) throw new RangeError("locale must contain formatRelative property");
	...
	return format(date, locale$1.formatRelative(token, utcDate, utcBaseDate, {
		locale: locale$1,
		weekStartsOn
	}), {
		locale: locale$1,
...
function getDaysInMonth(dirtyDate) {
	...
	var lastDayOfMonth$1 = /* @__PURE__ */ new Date(0);
...
var Setter = /* @__PURE__ */ function() {
	function Setter$1() {
		_classCallCheck(this, Setter$1);
		_defineProperty(this, "priority", void 0);
		_defineProperty(this, "subPriority", 0);
	}
	_createClass(Setter$1, [{
		key: "validate",
...
var ValueSetter = /* @__PURE__ */ function(_Setter) {
	_inherits(ValueSetter$1, _Setter);
	var _super = _createSuper(ValueSetter$1);
	function ValueSetter$1(value, validateValue, setValue, priority, subPriority) {
		var _this;
		_classCallCheck(this, ValueSetter$1);
	...
	_createClass(ValueSetter$1, [{
		...
		key: "set",
		value: function set$1(utcDate, flags, options) {
			return this.setValue(utcDate, flags, this.value, options);
		}
	}]);
	return ValueSetter$1;
}(Setter);
var DateToSystemTimezoneSetter = /* @__PURE__ */ function(_Setter2) {
	_inherits(DateToSystemTimezoneSetter$1, _Setter2);
	var _super2 = _createSuper(DateToSystemTimezoneSetter$1);
	function DateToSystemTimezoneSetter$1() {
		var _this2;
		_classCallCheck(this, DateToSystemTimezoneSetter$1);
	...
	_createClass(DateToSystemTimezoneSetter$1, [{
		key: "set",
		value: function set$1(date, flags) {
	...
	return DateToSystemTimezoneSetter$1;
}(Setter);
...
var Parser = /* @__PURE__ */ function() {
	...
	_createClass(Parser$1, [{
		key: "run",
		value: function run(dateString, token, match$1, options) {
			var result = this.parse(dateString, token, match$1, options);
...
var EraParser = /* @__PURE__ */ function(_Parser) {
	_inherits(EraParser$1, _Parser);
	var _super = _createSuper(EraParser$1);
	function EraParser$1() {
		var _this;
		_classCallCheck(this, EraParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
	...
	_createClass(EraParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token, match$1) {
			switch (token) {
				case "G":
				case "GG":
		...
		key: "set",
		value: function set$1(date, flags, value) {
			flags.era = value;
...
var YearParser = /* @__PURE__ */ function(_Parser) {
	_inherits(YearParser$1, _Parser);
	var _super = _createSuper(YearParser$1);
	function YearParser$1() {
		var _this;
		_classCallCheck(this, YearParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(YearParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				var valueCallback = function valueCallback$1(year) {
					return {
						year,
...
var LocalWeekYearParser = /* @__PURE__ */ function(_Parser) {
	_inherits(LocalWeekYearParser$1, _Parser);
	var _super = _createSuper(LocalWeekYearParser$1);
	function LocalWeekYearParser$1() {
		var _this;
		_classCallCheck(this, LocalWeekYearParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 130);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(LocalWeekYearParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				var valueCallback = function valueCallback$1(year) {
		...
		{
			key: "set",
			value: function set$1(date, flags, value, options) {
	...
	return LocalWeekYearParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/ISOWeekYearParser.js
var ISOWeekYearParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ISOWeekYearParser$1, _Parser);
	var _super = _createSuper(ISOWeekYearParser$1);
	function ISOWeekYearParser$1() {
		var _this;
		_classCallCheck(this, ISOWeekYearParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 130);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(ISOWeekYearParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token) {
			if (token === "R") return parseNDigitsSigned(4, dateString);
			return parseNDigitsSigned(token.length, dateString);
		}
	}, {
		key: "set",
		value: function set$1(_date, _flags, value) {
	...
	return ISOWeekYearParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/ExtendedYearParser.js
var ExtendedYearParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ExtendedYearParser$1, _Parser);
	var _super = _createSuper(ExtendedYearParser$1);
	function ExtendedYearParser$1() {
		var _this;
		_classCallCheck(this, ExtendedYearParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 130);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(ExtendedYearParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token) {
		...
		key: "set",
		value: function set$1(date, _flags, value) {
			date.setUTCFullYear(value, 0, 1);
			date.setUTCHours(0, 0, 0, 0);
			return date;
		}
	}]);
	return ExtendedYearParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/QuarterParser.js
var QuarterParser = /* @__PURE__ */ function(_Parser) {
	_inherits(QuarterParser$1, _Parser);
	var _super = _createSuper(QuarterParser$1);
	function QuarterParser$1() {
		var _this;
		_classCallCheck(this, QuarterParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	return QuarterParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/StandAloneQuarterParser.js
var StandAloneQuarterParser = /* @__PURE__ */ function(_Parser) {
	_inherits(StandAloneQuarterParser$1, _Parser);
	var _super = _createSuper(StandAloneQuarterParser$1);
	function StandAloneQuarterParser$1() {
		var _this;
		_classCallCheck(this, StandAloneQuarterParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 120);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(StandAloneQuarterParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
	...
	return StandAloneQuarterParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/MonthParser.js
var MonthParser = /* @__PURE__ */ function(_Parser) {
	_inherits(MonthParser$1, _Parser);
	var _super = _createSuper(MonthParser$1);
	function MonthParser$1() {
		var _this;
		_classCallCheck(this, MonthParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
			"Y",
	...
	_createClass(MonthParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				var valueCallback = function valueCallback$1(value) {
					return value - 1;
				};
				switch (token) {
	...
	return MonthParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/StandAloneMonthParser.js
var StandAloneMonthParser = /* @__PURE__ */ function(_Parser) {
	_inherits(StandAloneMonthParser$1, _Parser);
	var _super = _createSuper(StandAloneMonthParser$1);
	function StandAloneMonthParser$1() {
		var _this;
		_classCallCheck(this, StandAloneMonthParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 110);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(StandAloneMonthParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				var valueCallback = function valueCallback$1(value) {
	...
	return StandAloneMonthParser$1;
}(Parser);
...
var LocalWeekParser = /* @__PURE__ */ function(_Parser) {
	_inherits(LocalWeekParser$1, _Parser);
	var _super = _createSuper(LocalWeekParser$1);
	function LocalWeekParser$1() {
		var _this;
		_classCallCheck(this, LocalWeekParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(LocalWeekParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
		...
		{
			key: "set",
			value: function set$1(date, _flags, value, options) {
				return startOfUTCWeek(setUTCWeek(date, value, options), options);
			}
		}
	]);
	return LocalWeekParser$1;
}(Parser);
...
var ISOWeekParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ISOWeekParser$1, _Parser);
	var _super = _createSuper(ISOWeekParser$1);
	function ISOWeekParser$1() {
		var _this;
		_classCallCheck(this, ISOWeekParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 100);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
...
var DateParser = /* @__PURE__ */ function(_Parser) {
	_inherits(DateParser$1, _Parser);
	var _super = _createSuper(DateParser$1);
	function DateParser$1() {
		var _this;
		_classCallCheck(this, DateParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(DateParser$1, [
		...
		},
		{
			...
			value: function validate(date, value) {
				var isLeapYear$1 = isLeapYearIndex$1(date.getUTCFullYear());
				var month = date.getUTCMonth();
...
var DayOfYearParser = /* @__PURE__ */ function(_Parser) {
	_inherits(DayOfYearParser$1, _Parser);
	var _super = _createSuper(DayOfYearParser$1);
	function DayOfYearParser$1() {
		var _this;
		_classCallCheck(this, DayOfYearParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 90);
		_defineProperty(_assertThisInitialized(_this), "subpriority", 1);
	...
	_createClass(DayOfYearParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
...
var DayParser = /* @__PURE__ */ function(_Parser) {
	_inherits(DayParser$1, _Parser);
	var _super = _createSuper(DayParser$1);
	function DayParser$1() {
		var _this;
		_classCallCheck(this, DayParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 90);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
...
var LocalDayParser = /* @__PURE__ */ function(_Parser) {
	_inherits(LocalDayParser$1, _Parser);
	var _super = _createSuper(LocalDayParser$1);
	function LocalDayParser$1() {
		var _this;
		_classCallCheck(this, LocalDayParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 90);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(LocalDayParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1, options) {
				var valueCallback = function valueCallback$1(value) {
	...
	return LocalDayParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/StandAloneLocalDayParser.js
var StandAloneLocalDayParser = /* @__PURE__ */ function(_Parser) {
	_inherits(StandAloneLocalDayParser$1, _Parser);
	var _super = _createSuper(StandAloneLocalDayParser$1);
	function StandAloneLocalDayParser$1() {
		var _this;
		_classCallCheck(this, StandAloneLocalDayParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 90);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(StandAloneLocalDayParser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1, options) {
				var valueCallback = function valueCallback$1(value) {
	...
	return StandAloneLocalDayParser$1;
}(Parser);
...
var ISODayParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ISODayParser$1, _Parser);
	var _super = _createSuper(ISODayParser$1);
	function ISODayParser$1() {
		var _this;
		_classCallCheck(this, ISODayParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 90);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	return ISODayParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/AMPMParser.js
var AMPMParser = /* @__PURE__ */ function(_Parser) {
	_inherits(AMPMParser$1, _Parser);
	var _super = _createSuper(AMPMParser$1);
	function AMPMParser$1() {
		var _this;
		_classCallCheck(this, AMPMParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
...
var AMPMMidnightParser = /* @__PURE__ */ function(_Parser) {
	_inherits(AMPMMidnightParser$1, _Parser);
	var _super = _createSuper(AMPMMidnightParser$1);
	function AMPMMidnightParser$1() {
		var _this;
		_classCallCheck(this, AMPMMidnightParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 80);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(AMPMMidnightParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token, match$1) {
			switch (token) {
				case "b":
	...
	return AMPMMidnightParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/DayPeriodParser.js
var DayPeriodParser = /* @__PURE__ */ function(_Parser) {
	_inherits(DayPeriodParser$1, _Parser);
	var _super = _createSuper(DayPeriodParser$1);
	function DayPeriodParser$1() {
		var _this;
		_classCallCheck(this, DayPeriodParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 80);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(DayPeriodParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token, match$1) {
			switch (token) {
				case "B":
	...
	return DayPeriodParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/Hour1to12Parser.js
var Hour1to12Parser = /* @__PURE__ */ function(_Parser) {
	_inherits(Hour1to12Parser$1, _Parser);
	var _super = _createSuper(Hour1to12Parser$1);
	function Hour1to12Parser$1() {
		var _this;
		_classCallCheck(this, Hour1to12Parser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(Hour1to12Parser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
	...
	return Hour1to12Parser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/Hour0to23Parser.js
var Hour0to23Parser = /* @__PURE__ */ function(_Parser) {
	_inherits(Hour0to23Parser$1, _Parser);
	var _super = _createSuper(Hour0to23Parser$1);
	function Hour0to23Parser$1() {
		var _this;
		_classCallCheck(this, Hour0to23Parser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 70);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(Hour0to23Parser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
	...
	return Hour0to23Parser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/Hour0To11Parser.js
var Hour0To11Parser = /* @__PURE__ */ function(_Parser) {
	_inherits(Hour0To11Parser$1, _Parser);
	var _super = _createSuper(Hour0To11Parser$1);
	function Hour0To11Parser$1() {
		var _this;
		_classCallCheck(this, Hour0To11Parser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 70);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(Hour0To11Parser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
	...
	return Hour0To11Parser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/Hour1To24Parser.js
var Hour1To24Parser = /* @__PURE__ */ function(_Parser) {
	_inherits(Hour1To24Parser$1, _Parser);
	var _super = _createSuper(Hour1To24Parser$1);
	function Hour1To24Parser$1() {
		var _this;
		_classCallCheck(this, Hour1To24Parser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 70);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(Hour1To24Parser$1, [
		{
			key: "parse",
			value: function parse$1(dateString, token, match$1) {
				switch (token) {
	...
	return Hour1To24Parser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/MinuteParser.js
var MinuteParser = /* @__PURE__ */ function(_Parser) {
	_inherits(MinuteParser$1, _Parser);
	var _super = _createSuper(MinuteParser$1);
	function MinuteParser$1() {
		var _this;
		_classCallCheck(this, MinuteParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	return MinuteParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/SecondParser.js
var SecondParser = /* @__PURE__ */ function(_Parser) {
	_inherits(SecondParser$1, _Parser);
	var _super = _createSuper(SecondParser$1);
	function SecondParser$1() {
		var _this;
		_classCallCheck(this, SecondParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	return SecondParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/FractionOfSecondParser.js
var FractionOfSecondParser = /* @__PURE__ */ function(_Parser) {
	_inherits(FractionOfSecondParser$1, _Parser);
	var _super = _createSuper(FractionOfSecondParser$1);
	function FractionOfSecondParser$1() {
		var _this;
		_classCallCheck(this, FractionOfSecondParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(FractionOfSecondParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token) {
	...
	return FractionOfSecondParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/ISOTimezoneWithZParser.js
var ISOTimezoneWithZParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ISOTimezoneWithZParser$1, _Parser);
	var _super = _createSuper(ISOTimezoneWithZParser$1);
	function ISOTimezoneWithZParser$1() {
		var _this;
		_classCallCheck(this, ISOTimezoneWithZParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(ISOTimezoneWithZParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token) {
			switch (token) {
	...
	return ISOTimezoneWithZParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/ISOTimezoneParser.js
var ISOTimezoneParser = /* @__PURE__ */ function(_Parser) {
	_inherits(ISOTimezoneParser$1, _Parser);
	var _super = _createSuper(ISOTimezoneParser$1);
	function ISOTimezoneParser$1() {
		var _this;
		_classCallCheck(this, ISOTimezoneParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
		_defineProperty(_assertThisInitialized(_this), "priority", 10);
		_defineProperty(_assertThisInitialized(_this), "incompatibleTokens", [
	...
	_createClass(ISOTimezoneParser$1, [{
		key: "parse",
		value: function parse$1(dateString, token) {
			switch (token) {
				case "x": return parseTimezonePattern(timezonePatterns.basicOptionalMinutes, dateString);
	...
	return ISOTimezoneParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/TimestampSecondsParser.js
var TimestampSecondsParser = /* @__PURE__ */ function(_Parser) {
	_inherits(TimestampSecondsParser$1, _Parser);
	var _super = _createSuper(TimestampSecondsParser$1);
	function TimestampSecondsParser$1() {
		var _this;
		_classCallCheck(this, TimestampSecondsParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(TimestampSecondsParser$1, [{
		key: "parse",
		value: function parse$1(dateString) {
	...
	return TimestampSecondsParser$1;
}(Parser);

//#endregion
//#region node_modules/date-fns/esm/parse/_lib/parsers/TimestampMillisecondsParser.js
var TimestampMillisecondsParser = /* @__PURE__ */ function(_Parser) {
	_inherits(TimestampMillisecondsParser$1, _Parser);
	var _super = _createSuper(TimestampMillisecondsParser$1);
	function TimestampMillisecondsParser$1() {
		var _this;
		_classCallCheck(this, TimestampMillisecondsParser$1);
		for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) args[_key] = arguments[_key];
		_this = _super.call.apply(_super, [this].concat(args));
	...
	_createClass(TimestampMillisecondsParser$1, [{
		key: "parse",
		value: function parse$1(dateString) {
			return parseAnyDigitsSigned(dateString);
		}
	...
	return TimestampMillisecondsParser$1;
}(Parser);
...
function parse(dirtyDateString, dirtyFormatString, dirtyReferenceDate, options) {
	...
	var defaultOptions$1 = getDefaultOptions$1();
	var locale$1 = (_ref = (_options$locale = options === null || options === void 0 ? void 0 : options.locale) !== null && _options$locale !== void 0 ? _options$locale : defaultOptions$1.locale) !== null && _ref !== void 0 ? _ref : defaultLocale_default;
	if (!locale$1.match) throw new RangeError("locale must contain match property");
	var firstWeekContainsDate = toInteger((_ref2 = (_ref3 = (_ref4 = (_options$firstWeekCon = options === null || options === void 0 ? void 0 : options.firstWeekContainsDate) !== null && _options$firstWeekCon !== void 0 ? _options$firstWeekCon : options === null || options === void 0 ? void 0 : (_options$locale2 = options.locale) === null || _options$locale2 === void 0 ? void 0 : (_options$locale2$opti = _options$locale2.options) === null || _options$locale2$opti === void 0 ? void 0 : _options$locale2$opti.firstWeekContainsDate) !== null && _ref4 !== void 0 ? _ref4 : defaultOptions$1.firstWeekContainsDate) !== null && _ref3 !== void 0 ? _ref3 : (_defaultOptions$local = defaultOptions$1.locale) === null || _defaultOptions$local === void 0 ? void 0 : (_defaultOptions$local2 = _defaultOptions$local.options) === null || _defaultOptions$local2 === void 0 ? void 0 : _defaultOptions$local2.firstWeekContainsDate) !== null && _ref2 !== void 0 ? _ref2 : 1);
	if (!(firstWeekContainsDate >= 1 && firstWeekContainsDate <= 7)) throw new RangeError("firstWeekContainsDate must be between 1 and 7 inclusively");
	var weekStartsOn = toInteger((_ref5 = (_ref6 = (_ref7 = (_options$weekStartsOn = options === null || options === void 0 ? void 0 : options.weekStartsOn) !== null && _options$weekStartsOn !== void 0 ? _options$weekStartsOn : options === null || options === void 0 ? void 0 : (_options$locale3 = options.locale) === null || _options$locale3 === void 0 ? void 0 : (_options$locale3$opti = _options$locale3.options) === null || _options$locale3$opti === void 0 ? void 0 : _options$locale3$opti.weekStartsOn) !== null && _ref7 !== void 0 ? _ref7 : defaultOptions$1.weekStartsOn) !== null && _ref6 !== void 0 ? _ref6 : (_defaultOptions$local3 = defaultOptions$1.locale) === null || _defaultOptions$local3 === void 0 ? void 0 : (_defaultOptions$local4 = _defaultOptions$local3.options) === null || _defaultOptions$local4 === void 0 ? void 0 : _defaultOptions$local4.weekStartsOn) !== null && _ref5 !== void 0 ? _ref5 : 0);
	if (!(weekStartsOn >= 0 && weekStartsOn <= 6)) throw new RangeError("weekStartsOn must be between 0 and 6 inclusively");
	...
	var uniquePrioritySetters = setters.map(function(setter$1) {
		return setter$1.priority;
	}).sort(function(a, b) {
		return b - a;
	}).filter(function(priority, index, array) {
		return array.indexOf(priority) === index;
	}).map(function(priority) {
		return setters.filter(function(setter$1) {
			return setter$1.priority === priority;
		}).sort(function(a, b) {
...
function milliseconds(_ref) {
	var years = _ref.years, months$1 = _ref.months, weeks = _ref.weeks, days$1 = _ref.days, hours = _ref.hours, minutes = _ref.minutes, seconds = _ref.seconds;
	requiredArgs(1, arguments);
	var totalDays = 0;
	if (years) totalDays += years * daysInYear$1;
	if (months$1) totalDays += months$1 * (daysInYear$1 / 12);
...
function millisecondsToHours(milliseconds$1) {
	requiredArgs(1, arguments);
	var hours = milliseconds$1 / millisecondsInHour;
...
function millisecondsToMinutes(milliseconds$1) {
	requiredArgs(1, arguments);
	var minutes = milliseconds$1 / millisecondsInMinute;
...
function millisecondsToSeconds(milliseconds$1) {
	requiredArgs(1, arguments);
	var seconds = milliseconds$1 / millisecondsInSecond;
...
function monthsToQuarters(months$1) {
	requiredArgs(1, arguments);
	var quarters = months$1 / monthsInQuarter;
...
function monthsToYears(months$1) {
	requiredArgs(1, arguments);
	var years = months$1 / monthsInYear;
...
function parseYear(dateString, additionalDigits) {
	var regex = /* @__PURE__ */ new RegExp("^(?:(\\d{4}|[+-]\\d{" + (4 + additionalDigits) + "})|(\\d{2}|[+-]\\d{" + (2 + additionalDigits) + "})$)");
...
function setDefaultOptions(newOptions) {
	...
	var result = {};
	var defaultOptions$1 = getDefaultOptions$1();
	for (var property in defaultOptions$1) if (Object.prototype.hasOwnProperty.call(defaultOptions$1, property)) result[property] = defaultOptions$1[property];
...
function setMilliseconds(dirtyDate, dirtyMilliseconds) {
	requiredArgs(2, arguments);
	var date = toDate(dirtyDate);
	var milliseconds$1 = toInteger(dirtyMilliseconds);
...
function sub(date, duration) {
	...
	var minutes = duration.minutes ? toInteger(duration.minutes) : 0;
	var seconds = duration.seconds ? toInteger(duration.seconds) : 0;
	var dateWithoutDays = subDays(subMonths(date, months$1 + years * 12), days$1 + weeks * 7);
