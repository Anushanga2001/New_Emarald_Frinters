...
export function AboutPage() {
  ...
  return (
    <div>
      <Seo
        title="About Us"
        description="Founded in 2009, New Emarald Freighter is one of Sri Lanka's most trusted logistics partners, with strong connections to Colombo and Hambantota Ports and 15+ years of freight forwarding experience."
        path="/about"
      />
      {/* Hero */}
      <section className="bg-gradient-to-br from-slate-900 via-slate-900 to-blue-900 text-white py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <h1 className="text-4xl md:text-5xl font-bold mb-4">About New Emarald Freighter</h1>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              <p className="text-muted-foreground mb-4">
                Founded in 2009, New Emarald Freighter has grown from a small local freight forwarder to one of 
      ...
      <section className="py-16 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {values.map((value) => (
              <Card key={value.title} className="bg-gray-100 text-center">
